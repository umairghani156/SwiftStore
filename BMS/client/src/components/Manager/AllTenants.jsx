    ...
    <>
      <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
          ...
          {/* Users List */}
          <div className={`rounded-lg shadow-sm overflow-auto ${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white'
            }`}>
            {/* Mobile View */}
...
export default ManagerAllTenants;