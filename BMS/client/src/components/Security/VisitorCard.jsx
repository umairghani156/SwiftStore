...
import { FaBuilding, FaCalendarAlt, FaClock, FaDownload, FaEdit, FaIdCard, FaPhone, FaPrint, FaUserAlt } from "react-icons/fa";
                ...
                <div className="mt-4 sm:hidden px-2">
                    <nav className="flex items-center justify-between w-full">
                        <button
                            ...
                            className={`inline-flex items-center px-2 py-1 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed border ${
                                isDarkMode 
                    ...
                    <div className="flex-1 flex items-center justify-between">
                        ...
                        <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                            <button
                                onClick={prevPageHandle}
                                disabled={page.currentPage === 1}
                                className={`relative inline-flex items-center px-2 py-2 rounded-l-md border text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 ${
                                    isDarkMode 
                            ...
                            <button
                                onClick={nextPageHandle}
                                disabled={page.currentPage === (visitors?.pagination?.totalPages || 1)}
                                className={`relative inline-flex items-center px-2 py-2 rounded-r-md border text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 ${
                                    isDarkMode 
                                        ? 'border-gray-600 bg-gray-800 text-gray-300 hover:bg-gray-700' 
                                        : 'border-gray-300 bg-white text-gray-500 hover:bg-gray-50'
                                }`}
